...
# First plot all the percentage fixed effects
...
ggsave(filename = paste0(here("Outputs/Meta-regression/LMM_diagnostics/Fixed_effects/Predictions_"),ind[i],model_specs[j],".pdf"), width = 8, height = 8, device='pdf', dpi=300)